...
export type TFetchTechnologies = Action<ETechnologiesActionTypes.FETCH_TECHNOLOGIES>;
const fetchTechnologies = (): TFetchTechnologies =>
  ({
    type: ETechnologiesActionTypes.FETCH_TECHNOLOGIES,
  } as const);

export type TFetchTechnologiesSuccess = ActionWithPayload<ETechnologiesActionTypes.FETCH_TECHNOLOGIES_SUCCESS, ParsedGoogleSheets>;
const fetchTechnologiesSuccess = (data: ParsedGoogleSheets): TFetchTechnologiesSuccess => ({
  type: ETechnologiesActionTypes.FETCH_TECHNOLOGIES_SUCCESS,
  payload: data,
});

export type TFetchTechnologiesError = ActionWithError<ETechnologiesActionTypes.FETCH_TECHNOLOGIES_ERROR>;
